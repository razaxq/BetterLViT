...
for name in ('runtime.json', 'selection.json', 'p11_validation.json', 'p11_test.json',
             'p11_80_vs_150_validation.json', 'p11_80_vs_150_test.json'):
    path = run / name
    result['files'][name] = json.loads(path.read_text()) if path.exists() else None
runtime = result['files']['runtime.json']
repo = runtime['repository']
assert repo == '/root/autodl-tmp/BetterLViT-dual-grain-p11-150'
...
summary['comparison'] = data['files']['p11_80_vs_150_test.json']
