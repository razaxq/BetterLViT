...
a=json.loads((p/'c4_test.json').read_text()); b=json.loads((p/'p9_test.json').read_text())
for d in [a,b]:
...
(p/'c4_vs_p9_test.json').write_text(json.dumps(result,indent=2));print(json.dumps(result,indent=2))
