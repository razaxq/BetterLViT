...
items=read(HERE/'storage_candidates.json')
...
helper=helper.replace("/root/recipe_runs/hf_upload_cache","/root/autodl-tmp/visual_regroup_runs/hf_transfer_cache")
...
stage=Path('/root/autodl-tmp/visual_regroup_runs/historical_backup')/prefix
...
''',timeout=180)
    ...
    stage='/root/autodl-tmp/visual_regroup_runs/historical_backup/'+prefix
