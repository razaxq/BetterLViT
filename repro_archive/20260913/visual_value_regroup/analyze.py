...
def compare(base,candidate):
    ...
    assert base['experiment'] in ('r2_single_cosine','m1_visual_regroup')
    assert candidate['experiment'] in ('m1_visual_regroup','m2_text_regroup')
...
def main():
    ...
    mode={'m1':'regroup_visual','m2':'regroup_text'}[label]
    ...
    if label=='m2':
        m1=read(HERE/'m1_results/validation.json');save('m2_results/m2_vs_m1.json',compare(m1,val))
