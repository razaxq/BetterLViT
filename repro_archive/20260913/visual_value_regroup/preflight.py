...
ap.add_argument('mode',choices=('cpu','baseline','disabled','m1','m2','m1_observe','m2_observe','verify'))
...
if mode=='verify':
    ...
    assert read(HERE/'preflight/m1.json')['initial_adapter_sha256']==read(HERE/'preflight/m2.json')['initial_adapter_sha256']
    ...
    label='m2' if mode.startswith('m2') else 'm1'
    ...
    script='tools/check_visual_value_regroup.py' if mode=='cpu' else 'tools/preflight_decoder_context.py'
