...
HELPER=HERE.parent/'hf_recovery/upload_verified_manifest.py'
...
def main():
    ...
    if label=='s2':supplements['analysis/s1_vs_s2.json']=base64.b64encode((folder/'s1_vs_s2.json').read_bytes()).decode()
...
if manifest_path.exists():
    ...
    mapping.append((repo/'experiment_manifests/active_visual_aux.json',prefix+'/manifest.json'))
...
''',timeout=180)
    ...
    stage='/root/autodl-tmp/visual_aux_runs/hf_staging/'+prefix
