...
## 初始筛选已完成（2026-09-09 07:22）

R2完成80轮，Best67，Val macro IoU/Dice 0.7266535938/0.8240342868；IoU对C4 +0.0038572696，95%配对区间[0.0005122746,0.0071447087]，四项门槛均通过。R1未通过，R2进入已授权的额外匹配种子复验。两组均没有Test结果。两次末检约12/14分钟，旧定时已删除。详见[筛选汇总](SCREENING_SUMMARY.md)和[R2完整证据](r2_results/README.md)。
