...
from prepare_recipe import KEY, HERE, ROOT, remote
...
''')
    ...
    for name in (f'{label}_final_snapshot.json',f'{label}_summary.json',f'c4_vs_{label}.json',f'{label}_state.json',f'{label}_forecast.json'):
