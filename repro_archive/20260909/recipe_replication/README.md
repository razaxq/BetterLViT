...
R2-2027完整结果归档并推送后，C4-3407于2026-09-09 17:44:10.824（悉尼）提交，PID160309，来源 `02b28b2d455efdec4249cedd3d0ac7a865808283`，tag `experiment-c4-recipe-80e-seed3407-20260909`。当前只有启动回执，尚未检查健康，独立预算0/2。同一heartbeat `betterlvit-r2` 已改约今天18:00首次检查，再按实测完整轮时预测末检。启动前系统盘可用7,449,919,488字节，全部原模型保留。保持原注册控制配方；R2-3407来源已准备、尚未提交。

## R2-2027完成

80轮、Best68，Val macro IoU **0.7304811822**、Dice **0.8270935579**。相对匹配C4-2027，IoU **+0.0062910890（+0.6291个百分点）**，95%逐图配对区间[0.0030347233,0.0094778389]；Dice+0.0042291042、最小组IoU+0.0088166529，四项单种子门槛均通过。Precision+0.0172161529、Recall−0.0136806413。末检距结束643.221秒，预算2/2，符合30分钟约定。完整日志、结果、实际LR及模型来源已核验，[详细结果](r2s2027_results/README.md)。[两个已完成配对](TWO_SEED_PROGRESS.md)均为正向，仍须完成3407两组，未访问Test。
