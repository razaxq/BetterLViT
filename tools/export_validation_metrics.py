...
def main():
    ...
    if checkpoint.get('decoder_context') != adapter_metadata(config.decoder_context_mode):
        raise RuntimeError('Decoder context provenance mismatch')
    ...
    result = {
        ...
        "decoder_context": checkpoint.get('decoder_context'),
