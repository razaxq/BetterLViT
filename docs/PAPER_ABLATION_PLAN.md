...
budget, batch size and early-stopping rule.
...
- Dataset: QaTa-COV19-v2, fixed split of 5716 train, 1429 validation and 2113
  test images.
- Seed: 1219.
- Epoch budget: 200; the same configured early-stopping rule applies to all.
...
```powershell
D:\Project\BetterLViT\.venv\Scripts\python.exe tools\smoke_paper_profile.py --experiment b0_baseline
```
