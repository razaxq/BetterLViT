"""Only the eight authorized whole-module ablations, with immutable recipes."""
import os
from paper_experiments import get_paper_experiment
from training_recipe import planned_rates, rates_equal

PROFILES = {'j0_plam_r2':('J0','legacy_plam',False),
            'j2_plam_race_binding':('J2','legacy_plam',True),
            'p8_r2_binding':('J3','fam_eppa_v4b',True)}
...
def validate_manifest(m):
    ...
    assert group!='J3' or m['seed'] in (2027,3407), 'Reuse completed J3 seed1219'
    expected=dict(epochs=80,batch_size=16,image_size=224,num_workers=4,train_drop_last=True,
        ...
        augmentation_policy='legacy',lr_schedule='single_cosine',initialization='from_scratch',
